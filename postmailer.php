...
// Enhanced CORS headers for cross-domain requests
...
try {
    ...
    $testMail->SMTPDebug = 0; // Set to 2 for detailed debugging
    ...
    $testMail->Timeout = 10; // Increased timeout for better testing
