...
class SMTP
{
    ...
    /**
     * The maximum line length allowed for replies in RFC 5321.
     *
     * @var int
     */
    const MAX_REPLY_LENGTH = 512;
    ...
    /**
     * Debug level for client and server output.
     *
     * @var int
     */
    const DEBUG_SERVER = 2;
    ...
    /**
     * Debug level for connection, client, and server output.
     *
     * @var int
     */
    const DEBUG_CONNECTION = 3;
    ...
    /**
     * Debug level for low-level data output, connection, client, and server output.
     *
     * @var int
     */
    const DEBUG_LOWLEVEL = 4;
